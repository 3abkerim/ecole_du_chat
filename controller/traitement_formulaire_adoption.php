<?php
  ...
  $idChat = isset($_POST["id_chat"]) ? htmlspecialchars($_POST["id_chat"]) : NULL;
  ...
  $revenus = isset($_POST["revenus"]) ? htmlspecialchars($_POST["revenus"]) : NULL;
  ...
  $nourriture = isset($_POST["nourriture"]) ? htmlspecialchars($_POST["nourriture"]) : NULL;
  $budget = isset($_POST["budget"]) ? htmlspecialchars($_POST["budget"]) : NULL;
  $montantBudget = isset($_POST["montantBudget"]) ? htmlspecialchars($_POST["montantBudget"]) : NULL;
  $garde = isset($_POST["garde"]) ? htmlspecialchars($_POST["garde"]) : NULL;
  
  $raisonAdopter = isset($_POST["raisonAdopter"]) ? htmlspecialchars($_POST["raisonAdopter"]) : NULL;
  $raisonCeChat = isset($_POST["raisonCeChat"]) ? htmlspecialchars($_POST["raisonCeChat"]) : NULL;
  
  $adoptionMal = isset($_POST["adoptionMal"]) ? htmlspecialchars($_POST["adoptionMal"]) : NULL;
  ...
  $data = [
      ...
      'raison_adoption' => $raisonAdopter,
      'pq_ce_chat' => $raisonCeChat,
  
      'adoption_mal' => $adoptionMal,
  
      'form_type' => $formType
  ];
  
  
  $form = insertFormAdoption($bdd, $data);
  header('Location:form_adoption_reussi');
  
    }
    else {
        $_SESSION['form_data'] = $_POST;
        $_SESSION['error_recaptcha_ad']='La vérification reCAPTCHA a échoué. Veuillez réessayer.';
        header('Location:form_adoption-' . $idChat);
        exit();
    }
