      ...
      <tr>
        ...
        <td class="text-center">
          ...
          <div class="form-check form-switch mx-auto">
            <input class="form-check-input" type="checkbox" role="switch" data-type="chat" id="flexSwitchCheckDefault_<?php echo $chat['id_chat']; ?>" data-id="<?php echo $chat['id_chat']; ?>" <?php echo $chat['en_ligne'] == 1 ? 'checked' : ''; ?>  >
