...
<div class="text-center">
  <form method="post" action="traitement_modif_photo_chat" enctype="multipart/form-data" class="mt-5">
    <div class="mb-3 row">
  ...
  <div class="col-lg-4 col-sm-12 image-container text-center mb-3 imageItem drop-target" draggable="true" data-image='<?php echo $image['id_image']; ?>'>
    <div class="row">
      ...
      <div class="d-flex justify-content-center mt-2 col-lg-12">
        <a href="traitement_supprimer_photo_chat-<?php echo $idChat; ?>-<?php echo $image['id_image']; ?>  ">
