...
if (isset($_FILES['photo'])) {
    ...
    $upload_directory = '/home/ecoledl/www/public/assets/images/uploads/produits/';
    $base_url = "https://www.ecoleduchat.fr/public/assets/images/uploads/produits/";
    ...
    foreach ($_FILES['photo']['name'] as $i => $name) {
        if ($_FILES['photo']['size'][$i] > 0) {
            ...
            if (move_uploaded_file($_FILES['photo']['tmp_name'][$i], $uploaded_file_path)) {
                ...
                insertImagesProduit($bdd, $photo, $idProduit);
                $_SESSION['success_boutique_6'] = 'Les photos one été bien ajoutées';
            }
        }
    }
}
